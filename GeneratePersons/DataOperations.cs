...
namespace GeneratePersons
{
    public static class DataOperations
    {
        ...
        // Метод парсинга данных с сайта и добавление этих данных в коллекцию List
        public static async Task<List<FakeIdentity>> GetData()
        {
            int count = 1; // подсчет личностей
            ...
            try
            {
                ...
                for (int i = 0; i < 20; i++)
                {
                    ...
                    string address_part1 =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[1]/div/text()[1]").
                        First().InnerText;
                    string address_part2 =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[1]/div/text()[2]").
                        First().InnerText;
                    string country_code = document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[5]/dd/text()").
                        First().InnerText;
                    string birthday = document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[6]/dd/text()").
                        First().InnerText;
                    ...
                    string cvc2 = document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[16]/dd/text()").
                        First().InnerText;
                    ...
                    {
                        PersonName =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[1]/h3").
                        First().InnerText,
                        Addres = address_part1.TrimStart() + address_part2,
                        MothersMaidenName =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[1]/dd/text()").
                        First().InnerText,
                        Ssn =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[2]/dd/text()").
                        First().InnerText,
                        GeoCoordinates =
                        document.DocumentNode.SelectNodes("//*[@id=\"geo\"]").
                        First().InnerText,
                        Phone =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[4]/dd/text()").
                        First().InnerText,
                        ...
                        Age = age_result,
                        TropicalZodiac =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[8]/dd/text()").
                        First().InnerText,
                        Email =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[9]/dd/text()").
                        First().InnerText,
                        UserName =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[10]/dd/text()").
                        First().InnerText,
                        Password =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[11]/dd/text()").
                        First().InnerText,
                        Website =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[12]/dd/text()").
                        First().InnerText,
                        MasterCard =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[14]/dd/text()").
                        First().InnerText,
                        Expires =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[15]/dd/text()").
                        First().InnerText,
                        Cvc2 = Int32.Parse(cvc2),

                        Company =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[17]/dd/text()").
                        First().InnerText,
                        Occupation =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[18]/dd/text()").
                        First().InnerText,
                        Height =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[19]/dd/text()").
                        First().InnerText,
                        Weight =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[20]/dd/text()").
                        First().InnerText,
                        BloodType =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[21]/dd/text()").
                        First().InnerText,
                        FavoriteColor =
                        document.DocumentNode.SelectNodes("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[25]/dd/text()").
                        First().InnerText
                    };
        ...
        // Метод добавления данных из коллекции List в базу данных SQL Server
        ...
        // Метод установки GUID для созданных ранее записей в базе данных и коллекции List
        ...
        // Метод удаления существуюших записей из БД
        ...
        // Метод просмотра результирующих данных
